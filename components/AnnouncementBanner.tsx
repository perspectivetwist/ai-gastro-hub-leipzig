...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/leipzig-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <span className="font-semibold">84% der Leipziger Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
